...
| `02_MIDA_M_I.R` | **Model & Inquiry.** Funcyions that generate the synthetic CRM population of N = 5 0000 units using a logistic surrogate model to define baseline conversion probabilities and individual treatment effects (τᵢ). |
